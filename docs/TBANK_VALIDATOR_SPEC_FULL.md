...
> **Архивная версия от 21.07.2026.** Актуальное описание движка `6.5.5`,
> новых reassembly/serializer-проверок и всех шести подметодов находится в
> [`TBANK_VALIDATOR_SPEC_CURRENT.md`](./TBANK_VALIDATOR_SPEC_CURRENT.md).
