"""Deploy Alfa Oracle SBP hmtx HARD rule to the live bot."""
...
SMOKE = Path(r"C:\Users\fanis\Downloads\Telegram Desktop\alfa_sbp_114100.pdf")
...
if SMOKE.is_file():
    with sftp.file("/tmp/alfa_hmtx_smoke.pdf", "wb") as f:
    ...
    print(run(
        ...
        "r=analyze(Path('/tmp/alfa_hmtx_smoke.pdf').read_bytes()); "
