...
TIER_A_CODES: dict[str, str] = {
    ...
    "XREF_ENTRY_OBJECT_MISMATCH": "container_ambiguity_and_corruption",
    "XREF_GENERATION_MISMATCH": "container_ambiguity_and_corruption",
    "XREF_SUBSECTION_INVALID": "container_ambiguity_and_corruption",
    "XREF_SIZE_CONTRADICTION": "container_ambiguity_and_corruption",
    "XREF_DUPLICATE_LIVE_MAPPING": "container_ambiguity_and_corruption",
    ...
    "DUPLICATE_CRITICAL_DICT_KEY_CONFLICT": "container_ambiguity_and_corruption",
    "PAGETREE_PARENT_CONTRADICTION": "container_ambiguity_and_corruption",
    "PAGETREE_COUNT_CONTRADICTION": "container_ambiguity_and_corruption",
    "PAGETREE_CYCLE": "container_ambiguity_and_corruption",
    "PAGE_CONTENT_REFERENCE_INVALID": "container_ambiguity_and_corruption",
    "INDIRECT_REFERENCE_GENERATION_MISMATCH": "container_ambiguity_and_corruption",
    "CRITICAL_INDIRECT_REFERENCE_BROKEN": "container_ambiguity_and_corruption",
    "PDF_CRITICAL_PARSE_AMBIGUITY": "container_ambiguity_and_corruption",
    ...
    "STREAM_LENGTH_REFERENCE_INVALID": "stream_integrity_and_dos",
    "STREAM_LENGTH_TYPE_INVALID": "stream_integrity_and_dos",
    "STREAM_LENGTH_BOUNDARY_CONTRADICTION": "stream_integrity_and_dos",
    "STREAM_ENDSTREAM_CONTRADICTION": "stream_integrity_and_dos",
    # SFNT math (enabled only after zero-FP gate)
    "SFNT_TABLE_CHECKSUM_INVALID": "font_cmap_glyph",
    "SFNT_CHECKSUM_ADJUSTMENT_INVALID": "font_cmap_glyph",
    "SFNT_DIRECTORY_CONTRADICTION": "font_cmap_glyph",
